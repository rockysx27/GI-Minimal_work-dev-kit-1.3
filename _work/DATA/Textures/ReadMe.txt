To extract textures from local copy of the game:
...
5. Copy content of `gothic-devkit\tools\GothicZTEX` to this directory (`gothic-devkit\gothic\_work\data\TEXTURES`)
